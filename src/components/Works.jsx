        ...
        <div className='relative w-full h-[230px]'>
          ...
          <div className='absolute inset-0 flex justify-end m-3 card-img_hover'>
            <div
              ...
              className='bg-[#050816] w-10 h-10 rounded-full flex justify-center items-center cursor-pointer'
            >
              <img
                src={github}
                alt='source code'
...
const Works = () => {
  return (
    <>
      <motion.div variants={textVariant()} id="services">
        
        <h2 className={`${styles.heroHeadText} text-center justify-center`}>Our <span className="text-[#915EFF]">Services</span> </h2>
      </motion.div>

      <div className='w-full flex'>
        <div className='text-center justify-center'> {/* Add this div */}
          <motion.p
